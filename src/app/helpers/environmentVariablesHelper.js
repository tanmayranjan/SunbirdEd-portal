...
// let envVariables = {
//   LEARNER_URL: env.sunbird_learner_player_url || 'http://13.234.2.81/api/',
//   CONTENT_URL: env.sunbird_content_player_url || 'http://13.234.2.81/api/',
//   CONFIG_URL: env.sunbird_config_service_url || 'http://13.234.2.81/api/config/',
//   CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
//   CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
//   CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'http://13.234.2.81/',
//   PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
//   PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'http://13.234.2.81/auth',
//   PORTAL_AUTH_SERVER_CLIENT: env.sunbird_portal_auth_server_client || 'portal',
//   APPID: process.env.sunbird_environment + '.' + process.env.sunbird_instance + '.portal',
//   DEFAULT_CHANNEL: env.sunbird_default_channel || 'niit-Channel',
...
//   PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'http://13.234.2.81/api/echo/',
...
//   DATASERVICE_URL: env.sunbird_dataservice_url || 'http://13.234.2.81/api/',
//   KEY_CLOAK_PUBLIC: env.sunbird_keycloak_public || 'http://13.234.2.81/auth',
