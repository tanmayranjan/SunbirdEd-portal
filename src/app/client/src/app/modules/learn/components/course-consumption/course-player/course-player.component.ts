...
private getContentState() {
  ...
  //       console.log('heir', courseHierarchy, enrolledBatchDetails);
  ...
  //         if (this.enrolledBatchInfo.status && this.courseIds.length) {
  //           this.getContentState();
  ...
  //       this.courseIds.push(node.model.identifier);
  //     }
  //   });
  ...
  //   .subscribe(({courseId}) => {
  //     if (courseId) {
  //       const content = this.findContentById(courseId);
  ...
  //   const index = _.findIndex(this.contentDetails, ['id', this.courseId]);
  ...
  //     queryParams: { 'courseId': content.id },
  ...
  //   const contentMimeType = _.get(this.findContentById(this.courseId), 'model.mimeType');
