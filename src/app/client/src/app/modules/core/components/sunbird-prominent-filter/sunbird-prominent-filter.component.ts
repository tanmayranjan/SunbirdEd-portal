...
import { Component, OnInit, Input, Output, EventEmitter, ApplicationRef, ChangeDetectorRef, OnDestroy, OnChanges, ViewChild } from '@angular/core';
...
@Component({
  selector: 'app-sunbird-prominent-filter',
